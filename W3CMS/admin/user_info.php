          ...
          <form action="index.php" method="post" class="myForm">
            <div class="form__header">
              <div class="form__wrapped">
                <img class="form__avatar" src="<?= $user['image'] ?>" alt="Ảnh không tồn tại">
              ...
              <div class="form__wrapped">
                <div class="form__wrapped form__wrapped--row">
                  <div class="form__group">
                    ...
                    <input type="text" name="firstName" id="firstName" class="form__control" placeholder="First Name" disabled value="<?php 
                  ...
                  <div class="form__group">
                    ...
                    <input type="text" name="lastName" id="lastName" class="form__control" placeholder="Last Name" disabled value=<?php 
                      $arr = explode(" ", $user['fullname']);
                ...
                <div class="form__group">
                  ...
                  <input type="text" name="username" id="username" class="form__control" placeholder="Username" value="<?= $user['fullname'] ?> " disabled>
                </div>
                <div class="form__group">
                  <label for="email" class="form__label">Email<span class="mandatory">*</span></label>
                  <input type="email" name="email" id="email" class="form__control" placeholder="Email" value="<?= $user['email'] ?>" disabled>
                </div>
                <div class="form__group">
                  <label for="phone" class="form__label">Phone Number<span class="mandatory">*</span></label>
                  <input type="text" name="phone" id="phone" class="form__control" placeholder="Phone Number" value="<?= $user['mobile'] ?>" disabled>
                </div>
              </div>
            </div>
            <div class="form__body">
              <div class="form__wrapped form__wrapped--row">
                <div class="form__group">
                  ...
                  <select class="form__control" name="roles" id="roles" disabled>
                    <?php
                ...
                <div class="form__group">
                  ...
                  <select class="form__control" name="genders" id="genders" disabled>
                    <?php
                    if ($user['gender']) {
                      echo '<option value="Null">Choose gender</option>';
                ...
                <div class="form__group">
                  ...
                  <input class="form__control" type="date" name="dob" id="dob" placeholder="dob" value="<?= $user['dob'] ?>" disabled>
                </div>
              </div>
              <div class="form__wrapped form__wrapped--row">
                <div class="form__group">
                  <label for="fb" class="form__label">Facebook URL</label>
                  <input class="form__control" type="text" disabled name="fb" id="fb">
                </div>
                <div class="form__group">
                  <label for="twitter" class="form__label">Twitter URL</label>
                  <input class="form__control" type="text" disabled name="twitter" id="twitter">
                </div>
                <div class="form__group">
                  <label for="linkedin" class="form__label">Linkedin URL</label>
                  <input class="form__control" type="text" disabled name="linkedin" id="linkedin">
                </div>
              </div>
              <div class="form__group">
                <label class="form__label" for="about">About</label>
                <textarea class="form__control" name="about" disabled id="" cols="30" rows="10" placeholder="Write About YourSelf..."></textarea>
              </div>
              <div class="form__wrapped form__wrapped--row">
                <div class="form__group">
                  <label for="password" class="form__label">Password</label>
                  <input class="form__control" type="text" disabled name="password" id="password" placeholder="Password">
                </div>
              </div>
            </div>
